  export default function (type) {
    ...
    let country = [
      {
        s: '生物措施',
        x: ['造林(km²)','种草(km²)','封育(km²)','生态恢复(km²)']
      },
      {
        s: '工程措施',
        x: ['梯田(km²)','地埂(km²)','水平阶(反坡梯田)(km²)','水平沟(km²)',
        '竹节沟(km²)','鱼鳞坑(km²)','大型果树坑(km²)','引洪漫地(km²)',
        '引水拉沙造地(km²)','沙障固沙(km²)','坡面小型蓄排工程(km²)','路旁、沟底小型蓄引工程(km²)',
        '工程护路(km²)', '沟头防护(处)', '谷坊(处)', '淤地坝(座)']
      }
    ]
    let head = [ // 土地利用面积比例统计
      [
