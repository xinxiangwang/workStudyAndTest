export default function Trqs () {
  let head = [
    [
      { val: '名称', col: '2', row: '1' },
      { val: '土地总面积(km²)', col: '1', row: '3' },
      { val: '微度侵蚀', col: '2', row: '1' },
      { val: '水土流失', col: '2', row: '1' },
      { val: '轻度侵蚀', col: '2', row: '1' },
      { val: '中度侵蚀', col: '2', row: '1' },
      { val: '强度侵蚀', col: '2', row: '1' },
      { val: '极强烈侵蚀', col: '2', row: '1' },
      { val: '剧烈侵蚀', col: '2', row: '1' },
    ],
    [
      { val: '省名', col: '1', row: '2' },
      { val: '县名', col: '1', row: '2' },
      { val: '面积(km²)', col: '1', row: '1' },
      { val: '占土地面积(km²)', col: '1', row: '1' },
      { val: '面积(km²)', col: '1', row: '1' },
      { val: '占土地面积(km²)', col: '1', row: '1' },
      { val: '面积(km²)', col: '1', row: '1' },
      { val: '占土地面积(km²)', col: '1', row: '1' },
